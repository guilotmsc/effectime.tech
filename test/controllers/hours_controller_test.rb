...
class HoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hour" do
    assert_difference('Hour.count') do
      post hours_url, params: { hour: { corporation_id: @hour.corporation_id, volume: @hour.volume } }
    end
  ...
  test "should update hour" do
    patch hour_url(@hour), params: { hour: { corporation_id: @hour.corporation_id, volume: @hour.volume } }
