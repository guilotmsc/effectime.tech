...
class CorporationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create corporation" do
    assert_difference('Corporation.count') do
      post corporations_url, params: { corporation: { address: @corporation.address, city: @corporation.city, name: @corporation.name, state: @corporation.state } }
    end
  ...
  test "should update corporation" do
    patch corporation_url(@corporation), params: { corporation: { address: @corporation.address, city: @corporation.city, name: @corporation.name, state: @corporation.state } }
