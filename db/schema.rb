...
ActiveRecord::Schema.define(version: 20190928164858) do
  ...
  create_table "corporations", force: :cascade do |t|
    ...
    t.index ["workspace_id"], name: "index_corporations_on_workspace_id"
  end
  ...
  add_foreign_key "corporations", "workspaces"
